...
def get_path_of_suffix_files(
    root: str, suffix: str, with_create_time: bool = False
) -> list:
    """
...
def get_bleu4_score(
    reference: Union[str, list[str]], outputs: Union[str, list[str]], n_gram: int = 4
) -> float:
    """
    获取bleu4分数
    """
...
if __name__ == "__main__":
    ...
    print(
        sentence_bleu(
            [reference_corpus], candidate_corpus, weights=(0.25, 0.25, 0.25, 0.25)
        )
    )
